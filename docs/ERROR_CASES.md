...
**Симптом:** YOLO говорит «сфера», штрихкод ведёт в другой **рукав** (не другой «тип»).

**Причина:** это **разные оси** — штрихкод отвечает «куда», CV — «что за упаковка». Конфликт в metadata значит, что demo-fallback по классу не совпал с маршрутом по коду (или ошибка CV).
...
| **Политика** | На проде: штрихкод WMS → **рукав**; CV → **тип упаковки**, не город |
