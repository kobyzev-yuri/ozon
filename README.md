...
**Хакатон:** 2 июля — 13 сентября 2026, онлайн. Регистрация до **11 июля**. Полное ТЗ — **2 июля, 11:00 МСК**. См. [HACKATHON.md](HACKATHON.md).

## Документация

| Файл | Содержание |
|------|------------|
| [HACKATHON.md](HACKATHON.md) | **Сроки, формат, фокус задачи 3** |
...
Скелет v0.1 — полное ТЗ открывается **2 июля 2026, 11:00 МСК**. Дедлайн хакатона — **13 сентября**. PyBullet, обучение YOLO и Gradio — по критериям ТЗ.
